...
=======
        $sql = "UPDATE usuario SET usnombre='" . $this->getUsnombre() . "',uspass=" . $this->getUspass() . ",usmail = '" . $this->geetUsmail() . "',usdeshabilitado = '" . $this->getDeshabilitado() . "' WHERE idusuario=" . $this->getIdusuario();
>>>>>>> 776c3eedb2932a4b077aa4580b5fc347a6dc7eda
        if ($base->Iniciar()) {
